...
<body class="blog-page">
	...
	<main class="main">
		...
		<section id="hero" class="hero section dark-background">
			<div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
				...
				<div class="carousel-item <?php if ($no == 1) { echo 'active'; } ?>">
					<img src="<?= base_url('upload/caraousel/' . $aa['foto']); ?>" alt="">
					<div class="carousel-container">
						<!-- Menampilkan judul utama -->
						<h1><?= htmlspecialchars($aa['judul']); ?></h1>
						<!-- Menampilkan judul tambahan di bawahnya -->
						<h5><?= htmlspecialchars($aa['judul1']); ?></h5>
					</div>
				</div>
				<?php $no++; } ?>
				<!-- End Carousel Item -->
		...
		<section id="blog-posts-2" class="blog-posts-2 section">
			...
			<div class="container">
				<div class="row gy-4">
					<?php foreach ($konten1 as $konten) { ?>

					<div class="col-lg-4">
						<article class="position-relative h-100">

							<div class="post-img position-relative overflow-hidden">
								<img src="<?= base_url('upload/konten/' . $konten['foto']); ?>" class="img-fluid"
									alt="">
							</div>

							<div class="meta d-flex align-items-end">
								<span class="post-date"><span><?= $konten['tanggal']?></span></span>
								<div class="d-flex align-items-center">
									<i class="bi bi-person"></i> <span class="ps-2"><?= $konten['judul']?></span>
								</div>
								<span class="px-3 text-black-50">/</span>
								<div class="d-flex align-items-center">
									<i class="bi bi-folder2"></i> <span
										class="ps-2"><?= $konten['nama_kategori']?></span>
								</div>
							</div>

							<div class="post-content d-flex flex-column">

								<h3 class="post-title"><?= $konten['judul']?></h3>
			...
			<div
				...
				<div class="d-flex flex-column align-items-center align-items-lg-start">
					...
					<div class="credits">
						...
						Designed by <a href="https://bootstrapmade.com/"><?= $konfig->judul_website; ?></a> Distributed by <a
