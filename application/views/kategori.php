		...
		<div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
			...
			<nav id="navmenu" class="navmenu">
				<ul>
					...
					<li><a href="<?= base_url('home/kategori/'.$kategori['nama_kategori']) ?>">
					...
					<div class="col-lg-4">
						<article class="position-relative h-100">
							...
							<div class="meta d-flex align-items-end">
								...
								<div class="d-flex align-items-center">
									<i class="bi bi-folder2"></i> <span class="ps-2"><?= $konten['nama_kategori']?></span>
								</div>
							</div>
							...
							<div class="post-content d-flex flex-column">
								...
								<a href="<?= base_url('home/artikel/'.$konten['slug']) ?>" class="readmore stretched-link"><span>Baca selengkapnya</span><i
