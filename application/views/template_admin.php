...
<body>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="<?= base_url('assets/template/src')?>/assets/images/profile/user-1.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 dropdown-item">
                      <p class="ti ti-user fs-6"><?= $this->session->userdata('nama') ?></p>
                    </a>
                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 dropdown-item">
  ...
  <script src="<?= base_url('assets/template/src')?>/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
  <script src="<?= base_url('assets/template/src')?>/assets/libs/simplebar/dist/simplebar.js"></script>
  <script src="<?= base_url('assets/template/src')?>/assets/js/sidebarmenu.js"></script>
  <script src="<?= base_url('assets/template/src')?>/assets/js/app.min.js"></script>
  <script src="<?= base_url('assets/template/src')?>/assets/js/dashboard.js"></script>
